...
class TestScreeningFiltering:
    ...
    def test_filter_screenings_by_movie(self, api_client, make_movie, make_screening, hall):
        ...
        make_screening(movie=movie1, hall=hall)
        make_screening(movie=movie2, hall=hall)
    ...
    def test_filter_screenings_by_hall(self, api_client, make_screening, movie):
        ...
        make_screening(movie=movie, hall=hall1)
        make_screening(movie=movie, hall=hall2)
    ...
    def test_filter_screenings_by_movie_and_hall(self, api_client, make_movie, make_screening):
        ...
        make_screening(movie=movie1, hall=hall1)
        make_screening(movie=movie1, hall=hall2)
        make_screening(movie=movie2, hall=hall1)
...
class TestScreeningOrdering:
    ...
    def test_order_screenings_by_start_time_default(self, api_client, make_screening, movie, hall):
        ...
        make_screening(movie=movie, hall=hall, start_time=now + timezone.timedelta(hours=6))
        make_screening(movie=movie, hall=hall, start_time=now + timezone.timedelta(hours=3))
...
class TestScreeningCombinedFilterAndOrder:
    ...
    def test_filter_by_movie_and_order_by_start_time(self, api_client, make_movie, make_screening, hall):
        ...
        make_screening(movie=movie1, hall=hall, start_time=now + timezone.timedelta(hours=6))
        make_screening(movie=movie1, hall=hall, start_time=now + timezone.timedelta(hours=3))
        make_screening(movie=movie2, hall=hall, start_time=now + timezone.timedelta(hours=4))
