...
- Python 3.10+
- MariaDB ή MySQL (εγκατεστημένο και σε λειτουργία)
...
| `DB_USER` | Χρήστης MariaDB |
| `DB_PASSWORD` | Κωδικός MariaDB |
...
Τα tests χρησιμοποιούν SQLite ως test βάση (ορίζεται στο `pytest.ini`), χωρίς να χρειάζεται MariaDB.
