...
const PASS_TIERS = [
    {
        ...
        features: [
            'Watch entirely fictional movies',
            "Reserve seats that don't exist",
            "Brag about going to the cinema (you haven't)",
        ],
    ...
    },
    {
        ...
        features: [
            'Everything from Free, but somehow paid',
            'Our dev gets a coffee ☕',
            'Morally superior movie-watching',
        ],
    ...
    },
    {
        ...
        features: [
            'Identical to Pro (we checked twice)',
            'Your name in the credits (not really)',
            'Bragging rights at family dinners',
        ],
